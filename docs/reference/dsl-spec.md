...
- [Architecture Guide](../explanation/architecture.md) - Framework architecture
- [Quickstart Guide](../tutorials/quickstart.md) - Getting started
- [ADR-001: Framework Architecture](../../archive/legacy/adr/ADR-001-Soni-Framework-Architecture.md) - Detailed architecture decisions
