...
# =============================================================================
# Extensible Field Registry for Command Metrics
# =============================================================================
...
class FieldRegistry:
    ...
    Usage:
        ...
        FieldRegistry.register_command_type(
            cmd_type="my_custom_command",
            key_fields=["important_field"],
            value_fields=["optional_value"]
        )
    """
