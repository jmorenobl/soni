...
- [x] Hito 14: Step Compiler Parte 1 - StepParser lineal, StepCompiler, tests parsing/compilación
  - [x] Task 054: Implementar StepParser para parsing de steps lineales
  - [x] Task 055: Implementar StepCompiler para generar grafos lineales
  - [x] Task 056: Tests del compilador lineal
- [x] Hito 15: Step Compiler Parte 2 - Branches, jumps, validación grafo, tests condicionales
  - [x] Task 057: Soporte de branches en el compilador
  - [x] Task 058: Soporte de jumps en el compilador
  - [x] Task 059: Validación de grafo compilado
  - [x] Task 060: Tests del compilador con condicionales
