...
async def debug_flow():
    ...
    # Turn 2: Digression
    print("\n>>> Turn 2: 'how much do I have?' (Digression)")
    response2 = await runtime.process_message("how much do I have?", user_id)
    print(f"Bot: {response2}")
    await print_slots("After Turn 2 (Digression)")

    # Turn 3: "savings" (Answer to check_balance)
    print("\n>>> Turn 3: 'savings'")
    response3 = await runtime.process_message("savings", user_id)
